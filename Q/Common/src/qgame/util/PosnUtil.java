...
public class PosnUtil {
  ...
  public static boolean hasVerticalNeighbor(Posn posn, QMap state) {
    return hasDirectionalNeighbor(posn, state, PosnUtil::sameCol);
  }

  public static boolean hasHorizontalNeighbor(Posn posn, QMap state) {
    return hasDirectionalNeighbor(posn, state, PosnUtil::sameRow);
  }

  public static boolean hasDirectionalNeighbor(Posn posn, QMap state, BiPredicate<Posn,
    Posn> pred) {
