...
public abstract class CrawlingRule implements ScoringRule {
   ...
   */
  private void exploreInDirection(Posn starting, QGameMap map, Set<Posn> posnsConnected,
  ...
  protected void exploreVertical(Posn starting, QGameMap map, Set<Posn> posnsConnected) {
  ...
  protected void exploreHorizontal(Posn starting, QGameMap map, Set<Posn> posnsConnected) {
