 ...
 */
public abstract class CrawlingRule implements IScoringRule {
   ...
   */
  private void exploreInDirection(Posn starting, QMap map, Set<Posn> posnsConnected,
  ...
  protected void exploreVertical(Posn starting, QMap map, Set<Posn> posnsConnected) {
  ...
  protected void exploreHorizontal(Posn starting, QMap map, Set<Posn> posnsConnected) {
